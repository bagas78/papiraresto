        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                <form class="form-horizontal" method="post" action="<?php echo base_url('report/penjualan') ?>">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                <form class="form-horizontal" method="post" action="<?php echo base_url('report/penjualanByKar') ?>">
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <label for="">Tanggal Awal :</label>
                      <input type="date" id="awal" class="form-control datepicker" name="awal" required />
                  ...
                  <div class="form-group">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <select class="form-control select2" id="lbarangsup" name="iduser">
                          <option> - User - </option>
