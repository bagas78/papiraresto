...
if ($id_resi == null) {
    $sql_general = "SELECT a.invoice, a.bayar, a.kembali, a.ppn, a.tgl, b.nama_karyawan, b.id_karyawan, c.nama_cs, c.id_cs FROM penjualan a, karyawan b, customer c  WHERE a.id_cs = c.id_cs AND a.id_jual = '$id'";
    $sql_detail = "SELECT b.nama_barang, a.qty_jual, a.diskon, a.subtotal, a.harga_item FROM detil_penjualan a,  menu b
    ...
    $sql_general = "SELECT a.invoice, a.bayar, a.kembali, a.ppn, a.tgl, b.nama_karyawan, b.id_karyawan, c.nama_cs, c.id_cs FROM penjualan a, karyawan b, customer c WHERE a.id_cs = c.id_cs AND a.id_jual = '$id_resi'";
    $sql_detail = "SELECT b.nama_barang, a.qty_jual, a.diskon, a.subtotal, a.harga_item FROM detil_penjualan a,  menu b
...
foreach ($detail as $d) {
    ...
    $pdf->Cell(3.3, 0.4, 'Rp. ' . number_format($d['subtotal'], '0', '.', '.'), 0, 1, 'R');
...
$pdf->Cell(35, 0.5, 'DISKON              :   Rp. ' . @$diskon, 0, 1, 'L');
...
$pdf->Cell(35, 0.5, 'BAYAR               :   Rp. ' . @$general['bayar'], 0, 1, 'L');
$pdf->Cell(35, 0.5, 'Kembali              :   Rp. ' . @$general['kembali'], 0, 1, 'L');
