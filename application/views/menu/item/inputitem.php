 	...
 	<div class="modal-dialog">
 		<div class="modal-content">
 			...
 			<div class="modal-header">
 				...
 				<h4 class="modal-title" id="inputDataBarang">Entry Data Menu</h4>
 			</div>
 			<div class="modal-body">
 				<form class="form-horizontal" method="post" action="<?php echo base_url('menu/inputbarang') ?>">
 					...
 					<div class="form-group hide">
 						...
 						<div class="col-md-9 col-sm-9 col-xs-12">
 							<select id="is_bahan_baku" name="is_bahan_baku" class="form-control">
 								<?php if ($this->session->userdata('tipe') != 'Gudang') : ?>
 									<option value="">- Pilih -</option>
 									<option value="0">Menu</option>
 									<option value="1">Bahan Baku</option>
 								<?php else : ?>
 									<option value="1" selected>Bahan Baku</option>
 								<?php endif ?>
 							</select>
 						</div>
 					</div>
